#==================================================================================
# Script: 	Discover-TemperatureSensors.ps1
# Date:		03/06/20
# Author: 	Andi Patrick
# Purpose:	Gets F5 Device TemperatureSensors via SNMP returns all as Property Bag
#==================================================================================
...
$SCRIPT_NAME			= 'Discover-TemperatureSensors.ps1'
$EVENT_LEVEL_ERROR 		= 1
...
# Log Startup Message
$message =	"Started F5 Device Temperature Sensor Discovery."
...
If ($SNMPVersion -eq "3") {
	Try {
		# Try To Get TempSensor Count
		$TempCount = (Get-SnmpV3 $connection $sysChassisTempNumber).Data

		# Was there a vlid response
		If ($TempCount -eq $null)
		{
	...
	Try {
		# Try To Get TempSensor Count
		$TempCount = (Get-SnmpV2 $connection $sysChassisTempNumber).Data
